...
import com.example.android.triviaapp.databinding.FragmentGameWonBinding

class GameWonFragment : Fragment() {
    private lateinit var args: GameWonFragmentArgs

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?) = (DataBindingUtil.inflate(inflater,
        R.layout.fragment_game_won, container, false) as FragmentGameWonBinding)
        .also {
    ...
    private fun getShareIntent() = ShareCompat.IntentBuilder.from(requireActivity())
